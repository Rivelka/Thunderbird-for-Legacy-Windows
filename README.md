...
| **Windows Vista SP2** (NT 6.0) | x64 / x86 | 78.14.0 (88.0b3 & 89.0a1 in dev) | ✅ Supported (v78.14.0) / ⏳ In Progress (v88/v89) |
...
* **Native Bilingual Releases:** All releases provided in both Polish (`pl-PL`) and English (`en-US`).
...
* **[Thunderbird 78.14.0, 88.0b3 & 89.0a1](https://github.com/Rivelka/Thunderbird-for-Legacy-Windows/releases/tag/78.14.0-88.0b3-89.0a1)** — *August 30, 2026*  
  Added complete support for **Windows Vista SP2** (both **32-bit** and **64-bit** releases in PL and EN for version 78.14.0; intermediate builds 88.0b3 & 89.0a1 in active development).
