...
| **Windows Vista SP2** (NT 6.0) | x86 (x64 planned) | 78.14.0 (88.0b3 & 89.0a1 in dev) | ✅ Supported (v78 x86) / ⏳ In Progress |
...
* **Multi-Architecture Builds:** Releases packaged for both **32-bit (x86)** and **64-bit (x64)** systems.
* **API Wrappers & Shims:** Integrated `api-ms-win-shcore-scaling-l1-1-1.dll` DPI stubs for Windows 8/7, along with kernel API fallback redirection for Vista.
...
* **Native Bilingual Releases:** Packages available in both Polish (`pl-PL`) and English (`en-US`).

---

## 🛟 Releases

* **[Thunderbird 78.14.0 (Windows Vista SP2)](https://github.com/Rivelka/Thunderbird-for-Legacy-Windows/releases/tag/78.14.0-88.0b3-89.0a1)** — *August 30, 2026*  
  Added support for **Windows Vista SP2 (32-bit)** in Polish and English. (64-bit Vista build along with 88.0b3 & 89.0a1 coming soon).
...
- [x] Initial release of Thunderbird 78.14.0 for Windows Vista SP2 (32-bit).
- [ ] 64-bit (x64) build of Thunderbird 78.14.0 for Windows Vista SP2.
- [ ] Backport intermediate branches (Thunderbird 88.0b3 & 89.0a1 Proton UI) to Windows Vista SP2.
