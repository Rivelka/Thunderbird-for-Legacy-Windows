...
| **Windows Vista SP2** (NT 6.0) | x64 / x86 | 78.14.0, 88.0b3 (x86 PL), 89.0a1 (dev) | ✅ Supported (v78.14.0, v88.0b3 x86 PL) / ⏳ In Progress |
...
* **Bilingual Releases:** Builds available in Polish (`pl-PL`) and English (`en-US`).

---

## 🛟 Releases

* **[Thunderbird 78.14.0, 88.0b3 & 89.0a1](https://github.com/Rivelka/Thunderbird-for-Legacy-Windows/releases/tag/78.14.0-88.0b3-89.0a1)** — *Updated August 30, 2026*  
  Added **Thunderbird 88.0b3 (32-bit, Polish)** alongside full 78.14.0 builds (32-bit and 64-bit, PL & EN) for **Windows Vista SP2**. (64-bit & English packages for 88.0b3 and build 89.0a1 in active development).
...
- [x] Full release of Thunderbird 78.14.0 for Windows Vista SP2 (32-bit and 64-bit, PL & EN).
- [x] Release of Thunderbird 88.0b3 for Windows Vista SP2 (32-bit, Polish).
- [ ] 64-bit and English packages for Thunderbird 88.0b3 on Windows Vista SP2.
- [ ] Backport Thunderbird 89.0a1 (Proton UI) to Windows Vista SP2.
